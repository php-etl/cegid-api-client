...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class SystemWebODataQueryODataQueryOptionsCegidMtsResourceResourceBaseDtoReaderRequestNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === 'Cegid\\Api\\Model\\SystemWebODataQueryODataQueryOptionsCegidMtsResourceResourceBaseDtoReaderRequest';
        }

        public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
        {
            return is_object($data) && get_class($data) === 'Cegid\\Api\\Model\\SystemWebODataQueryODataQueryOptionsCegidMtsResourceResourceBaseDtoReaderRequest';
        }
        ...
        public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
        {
            ...
            $object = new \Cegid\Api\Model\SystemWebODataQueryODataQueryOptionsCegidMtsResourceResourceBaseDtoReaderRequest();
        ...
        {
            return ['Cegid\\Api\\Model\\SystemWebODataQueryODataQueryOptionsCegidMtsResourceResourceBaseDtoReaderRequest' => false];
        }
    }
} else {
    class SystemWebODataQueryODataQueryOptionsCegidMtsResourceResourceBaseDtoReaderRequestNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
