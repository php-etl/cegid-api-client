...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class CegidMtsContactContactDtoNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === 'Cegid\\Api\\Model\\CegidMtsContactContactDto';
        }

        public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
        {
            return is_object($data) && get_class($data) === 'Cegid\\Api\\Model\\CegidMtsContactContactDto';
        }
        ...
        public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
        {
            ...
            $object = new \Cegid\Api\Model\CegidMtsContactContactDto();
            ...
            if (\array_key_exists('TrackingFields', $data) && $data['TrackingFields'] !== null) {
                $object->setTrackingFields($this->denormalizer->denormalize($data['TrackingFields'], 'Cegid\\Api\\Model\\CegidMtsErpDataSystemFields', 'json', $context));
        ...
        public function normalize(mixed $object, ?string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
        {
            ...
            if ($object->isInitialized('trackingFields') && null !== $object->getTrackingFields()) {
                $data['TrackingFields'] = $this->normalizer->normalize($object->getTrackingFields(), 'json', $context);
            }
        ...
        {
            return ['Cegid\\Api\\Model\\CegidMtsContactContactDto' => false];
        }
    }
} else {
    class CegidMtsContactContactDtoNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
