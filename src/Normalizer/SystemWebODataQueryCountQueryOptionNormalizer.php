...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class SystemWebODataQueryCountQueryOptionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === 'Cegid\\Api\\Model\\SystemWebODataQueryCountQueryOption';
        }

        public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
        {
            return is_object($data) && get_class($data) === 'Cegid\\Api\\Model\\SystemWebODataQueryCountQueryOption';
        }
        ...
        public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
        {
            ...
            $object = new \Cegid\Api\Model\SystemWebODataQueryCountQueryOption();
            ...
            if (\array_key_exists('Validator', $data) && $data['Validator'] !== null) {
                $object->setValidator($this->denormalizer->denormalize($data['Validator'], 'Cegid\\Api\\Model\\SystemWebODataQueryValidatorsCountQueryValidator', 'json', $context));
        ...
        {
            return ['Cegid\\Api\\Model\\SystemWebODataQueryCountQueryOption' => false];
        }
    }
} else {
    class SystemWebODataQueryCountQueryOptionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
