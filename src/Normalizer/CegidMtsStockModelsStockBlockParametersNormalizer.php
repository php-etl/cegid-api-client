...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class CegidMtsStockModelsStockBlockParametersNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === 'Cegid\\Api\\Model\\CegidMtsStockModelsStockBlockParameters';
        }

        public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
        {
            return is_object($data) && get_class($data) === 'Cegid\\Api\\Model\\CegidMtsStockModelsStockBlockParameters';
        }
        ...
        public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
        {
            ...
            $object = new \Cegid\Api\Model\CegidMtsStockModelsStockBlockParameters();
            ...
            if (\array_key_exists('StockDetailKey', $data) && $data['StockDetailKey'] !== null) {
                $object->setStockDetailKey($this->denormalizer->denormalize($data['StockDetailKey'], 'Cegid\\Api\\Model\\CegidMtsStockModelsBlockStockDetailKey', 'json', $context));
        ...
        {
            return ['Cegid\\Api\\Model\\CegidMtsStockModelsStockBlockParameters' => false];
        }
    }
} else {
    class CegidMtsStockModelsStockBlockParametersNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
