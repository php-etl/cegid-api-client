...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class SystemWebODataQueryODataQueryOptionsCegidMtsActivityActivityBaseDtoReaderNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === 'Cegid\\Api\\Model\\SystemWebODataQueryODataQueryOptionsCegidMtsActivityActivityBaseDtoReader';
        }

        public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
        {
            return is_object($data) && get_class($data) === 'Cegid\\Api\\Model\\SystemWebODataQueryODataQueryOptionsCegidMtsActivityActivityBaseDtoReader';
        }
        ...
        public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
        {
            ...
            $object = new \Cegid\Api\Model\SystemWebODataQueryODataQueryOptionsCegidMtsActivityActivityBaseDtoReader();
            ...
            if (\array_key_exists('Request', $data) && $data['Request'] !== null) {
                $object->setRequest($this->denormalizer->denormalize($data['Request'], 'Cegid\\Api\\Model\\SystemWebODataQueryODataQueryOptionsCegidMtsActivityActivityBaseDtoReaderRequest', 'json', $context));
        ...
        {
            return ['Cegid\\Api\\Model\\SystemWebODataQueryODataQueryOptionsCegidMtsActivityActivityBaseDtoReader' => false];
        }
    }
} else {
    class SystemWebODataQueryODataQueryOptionsCegidMtsActivityActivityBaseDtoReaderNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
