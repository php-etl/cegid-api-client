...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class CegidMtsProductEntityUserDefinedDataNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === 'Cegid\\Api\\Model\\CegidMtsProductEntityUserDefinedData';
        }

        public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
        {
            return is_object($data) && get_class($data) === 'Cegid\\Api\\Model\\CegidMtsProductEntityUserDefinedData';
        }
        ...
        public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
        {
            ...
            $object = new \Cegid\Api\Model\CegidMtsProductEntityUserDefinedData();
            if (null === $data || false === \is_array($data)) {
                return $object;
            }
            if (\array_key_exists('Decisions', $data) && $data['Decisions'] !== null) {
                $object->setDecisions($this->denormalizer->denormalize($data['Decisions'], 'Cegid\\Api\\Model\\CegidMtsProductEntityUserDefinedDecisions', 'json', $context));
            ...
            if (\array_key_exists('Tables', $data) && $data['Tables'] !== null) {
                $object->setTables($this->denormalizer->denormalize($data['Tables'], 'Cegid\\Api\\Model\\CegidMtsProductEntityUserDefinedTables', 'json', $context));
            } elseif (\array_key_exists('Tables', $data) && $data['Tables'] === null) {
                $object->setTables(null);
            }
            if (\array_key_exists('Texts', $data) && $data['Texts'] !== null) {
                $object->setTexts($this->denormalizer->denormalize($data['Texts'], 'Cegid\\Api\\Model\\CegidMtsProductEntityUserDefinedTexts', 'json', $context));
            } elseif (\array_key_exists('Texts', $data) && $data['Texts'] === null) {
                $object->setTexts(null);
            }
            if (\array_key_exists('Values', $data) && $data['Values'] !== null) {
                $object->setValues($this->denormalizer->denormalize($data['Values'], 'Cegid\\Api\\Model\\CegidMtsProductEntityUserDefinedValues', 'json', $context));
            } elseif (\array_key_exists('Values', $data) && $data['Values'] === null) {
                $object->setValues(null);
            }
            if (\array_key_exists('Dates', $data) && $data['Dates'] !== null) {
                $object->setDates($this->denormalizer->denormalize($data['Dates'], 'Cegid\\Api\\Model\\CegidMtsProductEntityUserDefinedDates', 'json', $context));
        ...
        {
            return ['Cegid\\Api\\Model\\CegidMtsProductEntityUserDefinedData' => false];
        }
    }
} else {
    class CegidMtsProductEntityUserDefinedDataNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
