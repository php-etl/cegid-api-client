...
class CegidMtsResourceResourceBaseDtoReader
{
    /**
     * @var array
     */
    ...
    public function getEndDataFunction4(): ?\DateTime
    {
        return $this->endDataFunction4;
    }

    public function setEndDataFunction4(?\DateTime $endDataFunction4): self
    {
        $this->initialized['endDataFunction4'] = true;
        $this->endDataFunction4 = $endDataFunction4;
     ...
     * Libellé de l'agence.
     */
    public function setAgencyLabel(?string $agencyLabel): self
    {
        $this->initialized['agencyLabel'] = true;
