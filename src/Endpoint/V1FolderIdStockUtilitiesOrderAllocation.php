...
class V1FolderIdStockUtilitiesOrderAllocation extends \Cegid\Api\Runtime\Client\BaseEndpoint implements \Cegid\Api\Runtime\Client\Endpoint
{
    ...
    {
        return str_replace(['{folderId}', '{orderId}'], [$this->folderId, $this->orderId], '/api/v1/{folderId}/stock/utilities/allocation/order/{orderId}');
    }
