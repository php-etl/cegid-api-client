...
class V1FolderIdBusinessSideGetTaskResult extends \Cegid\Api\Runtime\Client\BaseEndpoint implements \Cegid\Api\Runtime\Client\Endpoint
{
    ...
    {
        return str_replace(['{folderId}'], [$this->folderId], '/api/v1/{folderId}/businessSide/getTaskResult');
    }
    ...
    protected function getQueryOptionsResolver(): \Symfony\Component\OptionsResolver\OptionsResolver
    {
        ...
        $optionsResolver->setDefined(['taskId']);
        $optionsResolver->setRequired(['taskId']);
        $optionsResolver->setDefaults([]);
        $optionsResolver->addAllowedTypes('taskId', ['string']);
