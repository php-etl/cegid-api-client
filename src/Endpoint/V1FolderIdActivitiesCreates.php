...
class V1FolderIdActivitiesCreates extends \Cegid\Api\Runtime\Client\BaseEndpoint implements \Cegid\Api\Runtime\Client\Endpoint
{
     ...
     */
    public function __construct(string $folderId, array $activities)
    {
    ...
    {
        return str_replace(['{folderId}'], [$this->folderId], '/api/v1/{folderId}/activities/createActivities');
    }
