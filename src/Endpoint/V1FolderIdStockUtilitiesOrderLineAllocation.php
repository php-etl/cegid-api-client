...
class V1FolderIdStockUtilitiesOrderLineAllocation extends \Cegid\Api\Runtime\Client\BaseEndpoint implements \Cegid\Api\Runtime\Client\Endpoint
{
    ...
    {
        return str_replace(['{folderId}', '{orderId}', '{lineNumber}'], [$this->folderId, $this->orderId, $this->lineNumber], '/api/v1/{folderId}/stock/utilities/allocation/order/{orderId}/line/{lineNumber}');
    }
