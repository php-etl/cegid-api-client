...
class V1FolderIdGdprCreateRequestForSelfService extends \Cegid\Api\Runtime\Client\BaseEndpoint implements \Cegid\Api\Runtime\Client\Endpoint
{
    ...
    {
        return str_replace(['{folderId}'], [$this->folderId], '/api/v1/{folderId}/gdpr/CreateRequestForSelfService');
    }
    ...
    protected function getQueryOptionsResolver(): \Symfony\Component\OptionsResolver\OptionsResolver
    {
        ...
        $optionsResolver->setDefined(['People', 'FieldValue', 'User', 'ConsentRequestStatus', 'ReturnDate']);
        $optionsResolver->setRequired(['People', 'FieldValue', 'User', 'ConsentRequestStatus', 'ReturnDate']);
