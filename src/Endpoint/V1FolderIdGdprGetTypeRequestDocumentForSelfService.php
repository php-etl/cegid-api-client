...
class V1FolderIdGdprGetTypeRequestDocumentForSelfService extends \Cegid\Api\Runtime\Client\BaseEndpoint implements \Cegid\Api\Runtime\Client\Endpoint
{
    ...
    {
        return str_replace(['{folderId}'], [$this->folderId], '/api/v1/{folderId}/gdpr/GetTypeRequestDocumentForSelfService');
    }
    ...
    protected function getQueryOptionsResolver(): \Symfony\Component\OptionsResolver\OptionsResolver
    {
        ...
        $optionsResolver->setDefined(['People']);
        $optionsResolver->setRequired(['People']);
