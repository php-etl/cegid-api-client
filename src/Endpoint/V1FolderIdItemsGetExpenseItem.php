...
class V1FolderIdItemsGetExpenseItem extends \Cegid\Api\Runtime\Client\BaseEndpoint implements \Cegid\Api\Runtime\Client\Endpoint
{
    ...
    {
        return str_replace(['{folderId}'], [$this->folderId], '/api/v1/{folderId}/items/getExpenseItems');
    }
    ...
    protected function getQueryOptionsResolver(): \Symfony\Component\OptionsResolver\OptionsResolver
    {
        ...
        $optionsResolver->setDefined(['resource', 'project', 'expenseDate']);
        $optionsResolver->setRequired(['resource', 'project', 'expenseDate']);
    ...
    /**
     * @return \Cegid\Api\Model\CegidMtsItemsItemDataDto[]
     *
    ...
    protected function transformResponseBody(\Psr\Http\Message\ResponseInterface $response, \Symfony\Component\Serializer\SerializerInterface $serializer, ?string $contentType = null)
    {
        ...
        if (200 === $status) {
            return $serializer->deserialize($body, 'Cegid\\Api\\Model\\CegidMtsItemsItemDataDto[]', 'json');
        }
