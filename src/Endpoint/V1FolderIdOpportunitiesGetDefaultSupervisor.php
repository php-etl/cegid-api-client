...
class V1FolderIdOpportunitiesGetDefaultSupervisor extends \Cegid\Api\Runtime\Client\BaseEndpoint implements \Cegid\Api\Runtime\Client\Endpoint
{
    ...
    {
        return str_replace(['{folderId}'], [$this->folderId], '/api/v1/{folderId}/opportunities/getDefaultSupervisor');
    }
