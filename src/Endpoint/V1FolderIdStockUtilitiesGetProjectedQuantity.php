...
class V1FolderIdStockUtilitiesGetProjectedQuantity extends \Cegid\Api\Runtime\Client\BaseEndpoint implements \Cegid\Api\Runtime\Client\Endpoint
{
    ...
    {
        return str_replace(['{folderId}'], [$this->folderId], '/api/v1/{folderId}/stock/utilities/getProjectedQuantity');
    }
    ...
    protected function getQueryOptionsResolver(): \Symfony\Component\OptionsResolver\OptionsResolver
    {
        ...
        $optionsResolver->setDefined(['warehouse', 'product', 'projectedDate']);
        $optionsResolver->setRequired(['warehouse', 'product', 'projectedDate']);
        $optionsResolver->setDefaults([]);
        $optionsResolver->addAllowedTypes('warehouse', ['string']);
        $optionsResolver->addAllowedTypes('product', ['string']);
        $optionsResolver->addAllowedTypes('projectedDate', ['string']);
